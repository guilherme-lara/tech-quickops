-- Atualiza a trigger de handle_new_user para fornecer 14 dias de teste (trial)
-- para novas empresas criadas através de sign-up público, em vez do padrão de 30 dias.
...
BEGIN
  ...
  -- Para contas novas (Trial), o período de teste inicial é de 14 dias em vez do padrão.
