-- Atualiza a função gerar_chave_licenca_segura para também ativar a licença e estender a validade
...
BEGIN
    ...
    -- Salva na tabela da empresa, ativa o status e renova por mais 30 dias
